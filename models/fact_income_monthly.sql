...
CREATE OR REPLACE TABLE oceanic-monitor-493207-i6.dbt_ellana94.fact_income_monthly AS (
...
WITH travel_income_monthly AS (
    ...
    FROM oceanic-monitor-493207-i6.dbt_ellana94.fact_travel_income
    GROUP BY 1, 2
)
...
, corpo_income_monnthly AS (
    SELECT
        ...
        ROUND(SUM(income), 2) AS income
    FROM oceanic-monitor-493207-i6.dbt_ellana94.fact_corpo_subscription_income
    GROUP BY 1, 2  
)
